...
const Footer = () => {
  return (
    <div>
      <div className="bg-black px=5 h-fit max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        <div className="px-4">
      ...
      <div className="text  my-10 w-full text-center">
